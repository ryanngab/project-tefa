    ...
    <div class="col-lg-8">
        <div class="colmd-12">
            ...
            <div class="card-body">
                    ...
                    <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data" class="mb-5">
                        ...
                        <div class="mb-3">
                            <label for="body" class="form-label  @error('name') is-invalid @enderror">Body</label>
                                @error('body')
